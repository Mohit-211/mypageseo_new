...
export function ServicesOverview() {
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-page pt-24 pb-16 md:pt-28 md:pb-20 text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            MyPageSEO combines specialist services with an integrated suite of
            software products — built specifically for businesses competing in
            local search across the United States and Canada.
          </p>
      ...
      <section className="bg-surface/60 border-y border-border/60">
        <div className="container-page py-20 grid gap-6 md:grid-cols-3">
          {[
            {
              icon: Layers,
              t: "Built to work together",
              c: "Data flows between products so your team sees the whole picture, not six disconnected reports.",
            },
            {
              icon: Zap,
              t: "One login, one experience",
              c: "A unified interface, roles, and billing across every product in the ecosystem.",
            },
            {
              icon: Cpu,
              t: "Local search-first",
              c: "Every product is designed around the realities of Local SEO — not generic marketing.",
            },
          ].map((x) => (
            <div
              key={x.t}
      ...
      {/* SERVICE SHOWCASE (alternating summary, links out to each service's own page) */}
          ...
          return (
            ...
            >
              <div>
                ...
                <p className="mt-5 text-base text-foreground/80 leading-relaxed max-w-lg">
                  {s.intro}
                </p>
