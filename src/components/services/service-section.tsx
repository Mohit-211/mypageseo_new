      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-page pt-20 pb-16 md:pt-24 md:pb-24 grid gap-12 lg:grid-cols-[1.15fr_1fr] items-center">
          <div>
            ...
            <h2 className="mt-6 text-4xl md:text-6xl font-semibold tracking-tight text-foreground">
              {service.name}
            </h2>
      ...
      <section className="container-page py-24">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] items-center">
          <div>
            ...
            <h3 className="mt-3 text-3xl md:text-4xl font-semibold tracking-tight">
              Built to fit how your team works.
            </h3>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              {service.name} slots into your existing operations — one login,
              one dashboard, and connections to the rest of the MyPageSEO
              ecosystem so your data works together.
            </p>
            <ul className="mt-6 space-y-3">
              {[
                "Connect your data sources",
                "Configure locations & teams",
