...
export const differentiators: { icon: LucideIcon; t: string; d: string }[] = [
  {
    icon: MapPin,
    t: "Local SEO specialization",
    d: "We don't do broad organic SEO campaigns. Every strategy, every playbook and every hire is dedicated to local visibility.",
  },
  {
    icon: Sparkles,
    t: "Experts + proprietary software",
    d: "Experienced Local SEO strategists paired with in-house software that continuously measures your local performance.",
  },
  {
    icon: LineChart,
    t: "Transparent reporting",
    d: "Clear, actionable insights — not spreadsheet dumps. You always know exactly what's happening and why.",
  },
  {
    icon: HeartHandshake,
    t: "Long-term partnerships",
    d: "We build sustainable growth, not short-term ranking tricks that evaporate the moment Google updates.",
  },
];
...
export const faqs = [
  {
    ...
    a: "Yes — completely. Traditional SEO chases global rankings for informational searches. Local SEO focuses on Google Maps, Google Business Profile, citations, reviews and location signals to win nearby customers with buying intent. It's a different discipline with different playbooks.",
  },
  {
    q: "Do I need a physical location to benefit from Local SEO?",
    a: "Not always. Service-area businesses (contractors, plumbers, mobile services) can rank in local search without a storefront by properly configuring service areas in Google Business Profile and building local authority.",
  },
  {
    q: "How long until I see results?",
    a: "Meaningful movement typically appears within 60–90 days, with compounding results across 6–12 months. Local SEO rewards consistency — we build sustainable rankings, not shortcuts.",
  },
  {
    q: "Is Google Business Profile optimization included?",
    a: "Yes. GBP optimization and ongoing management is included in every MyPageSEO engagement. It's the single most important local ranking factor.",
  },
  {
