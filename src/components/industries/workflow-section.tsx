    ...
    <section className="container-page py-24">
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          A repeatable methodology, tuned to your industry's realities. Every campaign moves through the same seven
          steps — the depth and emphasis change based on category.
        </p>
      </div>
