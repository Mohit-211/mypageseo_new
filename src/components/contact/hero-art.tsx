...
export function HeroArt() {
  return (
    <div className="relative">
      <div
        aria-hidden
        className="absolute -inset-6 rounded-[3rem] bg-radial-soft blur-2xl opacity-70"
      />
          ...
          <div className="col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-xs font-semibold text-foreground">
                  Casey — Success Specialist
                </div>
                <div className="text-[10px] text-muted-foreground">
                  Reviewing your Local SEO snapshot
                </div>
              </div>
            ...
            <div className="rounded-xl bg-surface-muted p-4">
              ...
              <svg viewBox="0 0 240 60" className="w-full h-12">
                <path
                  d="M0 50 L20 44 L40 46 L60 38 L80 34 L100 30 L120 22 L140 26 L160 18 L180 14 L200 10 L220 8 L240 4"
                  fill="none"
                  stroke="oklch(0.36 0.036 220)"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                />
                <path
                  d="M0 50 L20 44 L40 46 L60 38 L80 34 L100 30 L120 22 L140 26 L160 18 L180 14 L200 10 L220 8 L240 4 L240 60 L0 60 Z"
                  fill="oklch(0.36 0.036 220 / 0.08)"
                />
              </svg>
            </div>
            ...
            <div className="grid grid-cols-5 gap-1">
              {Array.from({ length: 25 }).map((_, i) => {
                ...
                return (
                  <div
                    key={i}
                    className={`aspect-square rounded ${color} text-[9px] text-white flex items-center justify-center font-semibold`}
                  >
                    {v}
                  </div>
                );
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="min-w-0">
            ...
            <div className="text-[11px] text-muted-foreground leading-snug">
              I pulled up your GBP audit — three quick wins to walk through.
            </div>
          </div>
        </div>
      </div>
      <div
        className="hidden md:block absolute -right-6 top-16 w-52 rounded-2xl bg-card ring-soft shadow-lift p-4 animate-float"
      ...
      >
        ...
        <div className="text-[11px] text-muted-foreground">
          Avg reply ·{" "}
          <span className="text-foreground font-medium">under 24 hours</span>
        </div>
      </div>
    </div>
  );
